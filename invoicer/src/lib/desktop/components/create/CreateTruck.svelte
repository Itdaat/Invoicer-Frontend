<script>
	...
	import { entityAlreadyExists, notLatinSymbol, trailer, trailers, trucks, unreachableError } from '../../../../consts';
...
<CreatePopup bind:show {save} title={t.title_truck}>
	<div class="main">
